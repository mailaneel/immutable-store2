...
function _prepareItem(item) {
	...
	if (item instanceof _immutable2['default'].Map) {
		return !item.has(CID_ATTRIBUTE) ? item.set(CID_ATTRIBUTE, _lodashUniqueid2['default'](CID_PREFIX)) : item;
	}

	return _lodashDefaults2['default'](item || {}, (_defaults = {}, _defaults[CID_ATTRIBUTE] = _lodashUniqueid2['default'](CID_PREFIX), _defaults));
};
