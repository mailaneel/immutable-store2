...
function Immutable(Collection) {
    ...
    return (function (_Collection) {
        ...
        _createClass(ImmutableCollection, [{
            key: '_prepareDocForInsert',
            value: function _prepareDocForInsert(doc) {
                doc = _get(Object.getPrototypeOf(ImmutableCollection.prototype), '_prepareDocForInsert', this).call(this, doc);
            ...
            key: '_prepareDocForUpdate',
            value: function _prepareDocForUpdate(existingDoc, newDoc) {
