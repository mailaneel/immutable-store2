...
var Collection = (function (_EventEmitter) {
    ...
    Collection.prototype.query = function query(criteria, projection) {
        return _mingo2['default'].find(this.data, criteria, projection);
    };
    ...
    Collection.prototype.aggregate = function aggregate(pipeline) {
        var args = [this.data, pipeline];
        return _mingo2['default'].aggregate.apply(null, args);
    };
