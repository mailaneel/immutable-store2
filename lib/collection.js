...
var Collection = (function (_Store) {
    ...
    Collection.prototype._add = function _add(item) {
        ...
        this.setState(this.state.push(_immutable2['default'].fromJS(item)));
        return this;
    };
        ...
        if (arguments.length == 1) {
            if (Array.isArray(id)) {
                id.forEach(function (itemToUpdate) {
                    return _this2._update(itemToUpdate, itemToUpdate);
                });
            } else {
                this._update(id, id);
            }
...
['find', 'findIndex'].forEach(function (method) {
    Collection.prototype[method] = function (id) {
        ...
        return this.state[method](function (item) {
            return item.get(_this3.idAttribute) === id || item.get(_this3.cidAttribute) === id;
        });
    };
});
